...
export const gpgpu = [
    nucleiGridGPU,
    shootedBarrierGPU,
    standardModelBlob2GPU,
    standardModelBlobSymetricGPU,
...
function standardModelBlob2GPU(graphics, physics) {
...
function standardModelBlobSymetricGPU(graphics, physics) {
    defaultParameters(graphics, physics, 15e3);
    fieldCleanup(graphics);
    setParticleRadius(50, 40);
