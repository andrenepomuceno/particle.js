    ...
    return (
        <div>
            ...
            <Typography variant="body1" gutterBottom>
                <p><b>particle.js</b> is a interactive n-body particle physics simulator, where fundamental particles can evolve and interact according to simplified physics laws.</p>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                <p>As the simulation is interactive, there's a lot more to have fun! See the "Control Panel" window and "Controls" menu for more.</p>
                <p>Check out the project on <a href="https://github.com/andrenepomuceno/particle.js" target="_blank" style={{ color: "#4CAF50" }}>GitHub</a> for more details and enjoy.</p>
            </Typography>
        </div>
    );
}
